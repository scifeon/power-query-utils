let
    ...
    Lt = (col as text, val as text) => col & " lt " & EscapeODataValue(val),
    ...
    IsNull = (col as text) => col & " isnull",
    IsNotNull = (col as text) => col & " isnotnull",
    IsEmpty = (col as text) => col & " isempty",
    IsNotEmpty = (col as text) => col & "isnotempty",
